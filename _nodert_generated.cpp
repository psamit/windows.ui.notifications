...
namespace NodeRT { namespace Windows { namespace UI { namespace Notifications { 
  ...
  v8::Local<v8::Value> WrapScheduledToastNotificationShowingEventArgs(::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^ wintRtInstance);
  ::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^ UnwrapScheduledToastNotificationShowingEventArgs(Local<Value> value);
  ...
  class ScheduledToastNotificationShowingEventArgs : public WrapperBase {
    public:
      ...
      static void Init(const Local<Object> exports) {
        ...
        Local<FunctionTemplate> localRef = Nan::New<FunctionTemplate>(New);
        s_constructorTemplate.Reset(localRef);
        localRef->SetClassName(Nan::New<String>("ScheduledToastNotificationShowingEventArgs").ToLocalChecked());
        localRef->InstanceTemplate()->SetInternalFieldCount(1);
            ...
            Nan::SetAccessor(localRef->PrototypeTemplate(), Nan::New<String>("scheduledToastNotification").ToLocalChecked(), ScheduledToastNotificationGetter);
        ...
        Nan::Set(exports, Nan::New<String>("ScheduledToastNotificationShowingEventArgs").ToLocalChecked(), constructor);
      }
    ...
    private:
      ...
      ScheduledToastNotificationShowingEventArgs(::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^ instance) {
        _instance = instance;
      }
    ...
    static void New(Nan::NAN_METHOD_ARGS_TYPE info) {
      ...
      ::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^ winRtInstance;


      if (info.Length() == 1 && OpaqueWrapper::IsOpaqueWrapper(info[0]) &&
        NodeRT::Utils::IsWinRtWrapperOf<::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^>(info[0])) {
        try {
          winRtInstance = (::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^) NodeRT::Utils::GetObjectInstance(info[0]);
        } catch (Platform::Exception ^exception) {
          NodeRT::Utils::ThrowWinRtExceptionInJs(exception);
          return;
        }
      ...
      ScheduledToastNotificationShowingEventArgs *wrapperInstance = new ScheduledToastNotificationShowingEventArgs(winRtInstance);
      wrapperInstance->Wrap(info.This());
    ...
    static void CastFrom(Nan::NAN_METHOD_ARGS_TYPE info) {
      HandleScope scope;
      if (info.Length() < 1 || !NodeRT::Utils::IsWinRtWrapperOf<::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^>(info[0])) {
        Nan::ThrowError(Nan::Error(NodeRT::Utils::NewString(L"Invalid arguments, no object provided, or given object could not be casted to requested type")));
        return;
      }
      ...
      info.GetReturnValue().Set(WrapScheduledToastNotificationShowingEventArgs(winRtInstance));
    }
    ...
    static void GetDeferral(Nan::NAN_METHOD_ARGS_TYPE info) {
      ...
      if (!NodeRT::Utils::IsWinRtWrapperOf<::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^>(info.This())) {
        return;
      }

      ScheduledToastNotificationShowingEventArgs *wrapper = ScheduledToastNotificationShowingEventArgs::Unwrap<ScheduledToastNotificationShowingEventArgs>(info.This());
    ...
    static void ScheduledToastNotificationGetter(Local<String> property, const Nan::PropertyCallbackInfo<v8::Value> &info) {
      HandleScope scope;
      ...
      try  {
        ::Windows::UI::Notifications::ScheduledToastNotification^ result = wrapper->_instance->ScheduledToastNotification;
        info.GetReturnValue().Set(WrapScheduledToastNotification(result));
        return;
      } catch (Platform::Exception ^exception) {
        NodeRT::Utils::ThrowWinRtExceptionInJs(exception);
        return;
    ...
    private:
      ::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^ _instance;
      static Persistent<FunctionTemplate> s_constructorTemplate;

      friend v8::Local<v8::Value> WrapScheduledToastNotificationShowingEventArgs(::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^ wintRtInstance);
      friend ::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^ UnwrapScheduledToastNotificationShowingEventArgs(Local<Value> value);
  };

  Persistent<FunctionTemplate> ScheduledToastNotificationShowingEventArgs::s_constructorTemplate;

  v8::Local<v8::Value> WrapScheduledToastNotificationShowingEventArgs(::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^ winRtInstance) {
    EscapableHandleScope scope;
    ...
    Local<Value> opaqueWrapper = CreateOpaqueWrapper(winRtInstance);
    Local<Value> args[] = {opaqueWrapper};
    Local<FunctionTemplate> localRef = Nan::New<FunctionTemplate>(ScheduledToastNotificationShowingEventArgs::s_constructorTemplate);
    return scope.Escape(Nan::NewInstance(Nan::GetFunction(localRef).ToLocalChecked(),_countof(args), args).ToLocalChecked());
  }

  ::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^ UnwrapScheduledToastNotificationShowingEventArgs(Local<Value> value) {
     return ScheduledToastNotificationShowingEventArgs::Unwrap<ScheduledToastNotificationShowingEventArgs>(Nan::To<Object>(value).ToLocalChecked())->_instance;
  }

  void InitScheduledToastNotificationShowingEventArgs(Local<Object> exports) {
    ScheduledToastNotificationShowingEventArgs::Init(exports);
  }
  ...
  class ToastNotification : public WrapperBase {
      ...
      static void Init(const Local<Object> exports) {
        ...
        localRef->InstanceTemplate()->SetInternalFieldCount(1);
          ...
          Nan::SetPrototypeMethod(localRef, "off", RemoveListener);
            ...
            Nan::SetAccessor(localRef->PrototypeTemplate(), Nan::New<String>("expiresOnReboot").ToLocalChecked(), ExpiresOnRebootGetter, ExpiresOnRebootSetter);
    ...
    static void ExpiresOnRebootGetter(Local<String> property, const Nan::PropertyCallbackInfo<v8::Value> &info) {
      HandleScope scope;
      ...
      try  {
        bool result = wrapper->_instance->ExpiresOnReboot;
        info.GetReturnValue().Set(Nan::New<Boolean>(result));
        return;
      } catch (Platform::Exception ^exception) {
        NodeRT::Utils::ThrowWinRtExceptionInJs(exception);
    ...
    static void ExpiresOnRebootSetter(Local<String> property, Local<Value> value, const Nan::PropertyCallbackInfo<void> &info) {
      HandleScope scope;
      ...
      try {
        ...
        wrapper->_instance->ExpiresOnReboot = winRtValue;
      } catch (Platform::Exception ^exception) {
        NodeRT::Utils::ThrowWinRtExceptionInJs(exception);
      }
    }
  ...
  class ToastNotifier : public WrapperBase {
    ...
    static void AddListener(Nan::NAN_METHOD_ARGS_TYPE info) {
      ...
      ::Windows::Foundation::EventRegistrationToken registrationToken;
      if (NodeRT::Utils::CaseInsenstiveEquals(L"scheduledToastNotificationShowing", str))
      {
        if (!NodeRT::Utils::IsWinRtWrapperOf<::Windows::UI::Notifications::ToastNotifier^>(info.This()))
        {
          Nan::ThrowError(Nan::Error(NodeRT::Utils::NewString(L"The caller of this method isn't of the expected type or internal WinRt object was disposed")));
      return;
        ...
        try {
          ...
          registrationToken = wrapper->_instance->ScheduledToastNotificationShowing::add(
            ref new ::Windows::Foundation::TypedEventHandler<::Windows::UI::Notifications::ToastNotifier^, ::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^>(
            [callbackObjPtr](::Windows::UI::Notifications::ToastNotifier^ arg0, ::Windows::UI::Notifications::ScheduledToastNotificationShowingEventArgs^ arg1) {
              NodeUtils::Async::RunOnMain([callbackObjPtr , arg0, arg1]() {
                HandleScope scope;
...

                {
                  ...
                  wrappedArg0 = WrapToastNotifier(arg0);
                  wrappedArg1 = WrapScheduledToastNotificationShowingEventArgs(arg1);
    ...
    static void RemoveListener(Nan::NAN_METHOD_ARGS_TYPE info) {
      ...
      try  {
        if (NodeRT::Utils::CaseInsenstiveEquals(L"scheduledToastNotificationShowing", str)) {
          ...
          ToastNotifier *wrapper = ToastNotifier::Unwrap<ToastNotifier>(info.This());
          wrapper->_instance->ScheduledToastNotificationShowing::remove(registrationToken);
        }
      } catch (Platform::Exception ^exception) {
        NodeRT::Utils::ThrowWinRtExceptionInJs(exception);
      }
...
NAN_MODULE_INIT(init) {
  ...
  */
      ...
      NodeRT::Windows::UI::Notifications::InitScheduledToastNotificationShowingEventArgs(target);
