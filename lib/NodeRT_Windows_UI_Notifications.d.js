...
ScheduledToastNotificationShowingEventArgs = (function () {
  var cls = function ScheduledToastNotificationShowingEventArgs() {
    this.cancel = new Boolean();
    this.scheduledToastNotification = new ScheduledToastNotification();
  };
...
exports.ScheduledToastNotificationShowingEventArgs = ScheduledToastNotificationShowingEventArgs;
...
ToastNotification = (function () {
  var cls = function ToastNotification() {
    ...
    this.expiresOnReboot = new Boolean();
  };
